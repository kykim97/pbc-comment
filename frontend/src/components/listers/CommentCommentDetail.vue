<template>
    <v-card outlined>
        <v-card-title>
            CommentComment # {{item._links.self.href.split("/")[item._links.self.href.split("/").length - 1]}}
        </v-card-title>
        ...
        <v-card-text>
            ...
            <div>
                <String label="RepliedId" v-model="item.repliedId" :editMode="editMode" @change="change" />
            </div>
            <div>
